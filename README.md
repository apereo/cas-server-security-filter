...
This project provides blunt generic Filters suitable for patching-in-place Java CAS server and Java CAS client 
deployments vulnerable to certain request parameter based bad-CAS-protocol-input attacks.
...
SecurityFilter for patching the CAS Server
------------------------------------------

This Filter is a J2E filter to be installed in all CAS servers for version < 4.1.
